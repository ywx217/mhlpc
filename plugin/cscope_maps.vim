...
if has("cscope")
    ...
    "    nmap <F8>s <C-W><C-S> :cs find s <C-R>=expand("<cword>")<CR><CR>	

    nmap <F7>s :scs find s <C-R>=expand("<cword>")<CR><CR>	
    nmap <F7>g :scs find g <C-R>=expand("<cword>")<CR><CR>	
    ...
    nmap <F8>s :vert scs find s <C-R>=expand("<cword>")<CR><CR><ESC>:cw<CR>
